	...
	kit: {
		...
		prerender: {
			...
			entries: [
				...
				'/merchants/31_geprel_mas_al', '/merchants/33_martabak_la_wawah', '/merchants/35_mie_serasi', '/merchants/36_gacoan_jebres', '/merchants/37_kedai_kabut', '/merchants/38_uma_yumcha',
			],
		}
	}
};
