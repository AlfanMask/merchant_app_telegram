<script lang="ts">
    ...
    $: {
        orders = orderables.filter(o => o.qty > 0)
    }
...
<div class="min-h-screen h-full bg-primary relative">
    <!-- header -->
    <div id="header" class="relative flex justify-center mb-8">
        ...
        <!-- topbar -->
        <div id="topbar" class="absolute top-4 w-full px-4 mb-8 flex flex-col gap-1 items-center">
    ...
    <!-- main -->
    <div id="main" class="flex flex-col gap-12 px-4">
        <!-- foods -->
        <div id="foods" class="flex flex-col gap-4">
            <h3 class="text-start text-dark">Makanan</h3>
            <div id="food-list" class="flex flex-col gap-4">
